...
Login in your keycloak instance, typically at http://localhost:13300/admin
...
4. **Login settings**:
   - **Valid redirect URIs**:
     - `http://localhost:8355/*` (for local development)
...
```
KEYCLOAK_URL=http://localhost:13300
KEYCLOAK_REALM=cfl
...
FRONTEND_URL=http://localhost:8355  # Your frontend URL for CORS
PORT=9305  # Backend port
```
...
VITE_KEYCLOAK_AUTH_SERVER_URL=http://localhost:13300/
